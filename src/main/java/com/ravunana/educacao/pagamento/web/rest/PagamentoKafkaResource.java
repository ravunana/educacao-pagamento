...
@RestController
@RequestMapping("/api/pagamento-kafka")
public class PagamentoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PagamentoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PagamentoKafkaResource(KafkaProperties kafkaProperties) {
